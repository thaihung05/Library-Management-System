...
namespace Library
{
    public partial class DanhSachUI : Form
    {
        public DanhSachUI()
        {
            InitializeComponent();
        ...
        {
            UI user = new UI(TrangThai.currentUser);
            user.Show();
            this.Close();
        }
        ...
        {
            LichSuMuoncs lichSuMuoncs = new LichSuMuoncs();
            lichSuMuoncs.Show();
            this.Close();
        }

        private void yêuThíchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            YeuThichcs y  = new YeuThichcs();   
            y.Show();
            this.Close();
        }
        ...
        {
            UI u = new UI(TrangThai.currentUser);
            u.Show();
            this.Close();
        }
    }
